...
async function main() {
    ...
    console.log('--- ZkWhistle Issuer Tool ---');
    try {
        ...
        const { stdout } = await execAsync(`node src/hash-vc.mjs ${ownerSkHex} ${labResults.cholesterol} ${labResults.bloodPressure} ${labResults.isSmoker}`);
        ...
        await fs.writeFile(outputPath, JSON.stringify(credential, (key, value) => typeof value === 'bigint' ? value.toString() : value, 2));
        console.log(`
...
main();
//# sourceMappingURL=issuer-tool.js.map