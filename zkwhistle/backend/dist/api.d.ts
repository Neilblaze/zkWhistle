...
import { type VerifierContract, type VerifierProviders, type DeployedVerifierContract, VerifierCircuits } from './common-types';
import { type Config } from './config';
import * as fs from 'node:fs';
export declare const getVerifierLedgerState: (providers: VerifierProviders, contractAddress: ContractAddress) => Promise<string | null>;
...
export declare const deploy: (providers: VerifierProviders, ownerSk: Uint8Array) => Promise<DeployedVerifierContract>;
export declare const addIssuer: (providers: VerifierProviders, verifierContract: DeployedVerifierContract, ownerSk: Uint8Array, issuerKey: Uint8Array) => Promise<FinalizedTxData>;
export declare const revokeIssuer: (providers: VerifierProviders, verifierContract: DeployedVerifierContract, ownerSk: Uint8Array, issuerKey: Uint8Array) => Promise<FinalizedTxData>;
export declare const getChallenge: (verifierContract: DeployedVerifierContract) => Promise<bigint>;
export declare const submitHealthProof: (verifierContract: DeployedVerifierContract, challenge: bigint, issuerKey: Uint8Array) => Promise<FinalizedTxData>;
...
export declare const configureProviders: (wallet: Wallet & Resource, config: Config) => Promise<{
    ...
    zkConfigProvider: NodeZkConfigProvider<VerifierCircuits>;
